...
jQuery(function ($) {
	...
	// Card Block Tag Filtering
	$(".card-tag-link").click(function (e) {
		e.preventDefault();
		var filterValue = $(this).data("card-tag-filter");
		$(".card-tag-link").removeClass("current-cat");
		$(this).addClass("current-cat");
		// Filter cards based on the selected tag
		$(".card-col").each(function () {
			if ($(this).data("card-tag") === filterValue || filterValue === "all") {
				$(this).show();
			} else {
				$(this).hide();
			}
