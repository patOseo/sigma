...
/*!
	  ...
	  * Copyright 2011-2022 The Bootstrap Authors (https://github.com/twbs/bootstrap/graphs/contributors)
	  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
	  */!function(e,t){e.exports=function(e,t){const n=(e=>e&&"object"==typeof e&&"default"in e?e:{default:e})(t),i="popover",s=".popover-header",o=".popover-body",r={...n.default.Default,content:"",offset:[0,8],placement:"right",template:'<div class="popover" role="tooltip"><div class="popover-arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>',trigger:"click"},a={...n.default.DefaultType,content:"(null|string|element|function)"};class l extends n.default{static get Default(){return r}static get DefaultType(){return a}static get NAME(){return i}_isWithContent(){return this._getTitle()||this._getContent()}_getContentForTemplate(){return{[s]:this._getTitle(),[o]:this._getContent()}}_getContent(){return this._resolvePossibleFunction(this._config.content)}static jQueryInterface(e){return this.each((function(){const t=l.getOrCreateInstance(this,e);if("string"==typeof e){if(void 0===t[e])throw new TypeError(`No method named "${e}"`);t[e]()}}))}}return e.defineJQueryPlugin(l),l}(r(),$t.exports)}(Pt);var Bt=Pt.exports,zt={exports:{}};
/*!
...
/*!
	  ...
	  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
	  */
!function(e,t){e.exports=function(e,t,n,i){const s=e=>e&&"object"==typeof e&&"default"in e?e:{default:e},o=s(t),r=s(n),a="toast",l=".bs.toast",c=`mouseover${l}`,u=`mouseout${l}`,d=`focusin${l}`,f=`focusout${l}`,h=`hide${l}`,p=`hidden${l}`,g=`show${l}`,m=`shown${l}`,_="fade",b="hide",v="show",y="showing",w={animation:"boolean",autohide:"boolean",delay:"number"},x={animation:!0,autohide:!0,delay:5e3};class E extends r.default{constructor(e,t){super(e,t),this._timeout=null,this._hasMouseInteraction=!1,this._hasKeyboardInteraction=!1,this._setListeners()}static get Default(){return x}static get DefaultType(){return w}static get NAME(){return a}show(){if(o.default.trigger(this._element,g).defaultPrevented)return;this._clearTimeout(),this._config.animation&&this._element.classList.add(_);const t=()=>{this._element.classList.remove(y),o.default.trigger(this._element,m),this._maybeScheduleHide()};this._element.classList.remove(b),e.reflow(this._element),this._element.classList.add(v,y),this._queueCallback(t,this._element,this._config.animation)}hide(){if(!this.isShown())return;if(o.default.trigger(this._element,h).defaultPrevented)return;const e=()=>{this._element.classList.add(b),this._element.classList.remove(y,v),o.default.trigger(this._element,p)};this._element.classList.add(y),this._queueCallback(e,this._element,this._config.animation)}dispose(){this._clearTimeout(),this.isShown()&&this._element.classList.remove(v),super.dispose()}isShown(){return this._element.classList.contains(v)}_maybeScheduleHide(){this._config.autohide&&(this._hasMouseInteraction||this._hasKeyboardInteraction||(this._timeout=setTimeout((()=>{this.hide()}),this._config.delay)))}_onInteraction(e,t){switch(e.type){case"mouseover":case"mouseout":this._hasMouseInteraction=t;break;case"focusin":case"focusout":this._hasKeyboardInteraction=t}if(t)return void this._clearTimeout();const n=e.relatedTarget;this._element===n||this._element.contains(n)||this._maybeScheduleHide()}_setListeners(){o.default.on(this._element,c,(e=>this._onInteraction(e,!0))),o.default.on(this._element,u,(e=>this._onInteraction(e,!1))),o.default.on(this._element,d,(e=>this._onInteraction(e,!0))),o.default.on(this._element,f,(e=>this._onInteraction(e,!1)))}_clearTimeout(){clearTimeout(this._timeout),this._timeout=null}static jQueryInterface(e){return this.each((function(){const t=E.getOrCreateInstance(this,e);if("string"==typeof e){if(void 0===t[e])throw new TypeError(`No method named "${e}"`);t[e](this)}}))}}return i.enableDismissTrigger(E),e.defineJQueryPlugin(E),E}(r(),c(),w(),A())}(Qt);var Kt,Xt,Yt,Ut=Qt.exports;Kt=navigator.userAgent.toLowerCase().indexOf("webkit")>-1,Xt=navigator.userAgent.toLowerCase().indexOf("opera")>-1,Yt=navigator.userAgent.toLowerCase().indexOf("msie")>-1,(Kt||Xt||Yt)&&document.getElementById&&window.addEventListener&&window.addEventListener("hashchange",(function(){var e,t=location.hash.substring(1);/^[A-z0-9_-]+$/.test(t)&&(e=document.getElementById(t))&&(/^(?:a|select|input|button|textarea)$/i.test(e.tagName)||(e.tabIndex=-1),e.focus())}),!1),jQuery((function(e){document.querySelector('script[src="//js.hsforms.net/forms/embed/v2.js"]')&&setTimeout((function(){e(".hs-form-iframe").css("height","+=100px")}),2e3),e("body").scrollspy({target:"#tableContents",offset:200}),e(window).scroll((function(){e(this).scrollTop()>300?e("#toTopButton").removeClass("hidden"):e("#toTopButton").addClass("hidden")})),e("#toTopButton").click((function(e){e.preventDefault(),window.scrollTo({top:0,behavior:"smooth"})}));e("#main-nav .menu-item.dropdown").each((function(){e(this).append('<div class="dropdown-trigger p-1 position-absolute top-50 end-0 translate-middle d-xl-none text-center lh-1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="#ffffff" d="M233.4 406.6c12.5 12.5 32.8 12.5 45.3 0l192-192c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L256 338.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l192 192z"/></svg></div>')})),e("#main-nav .menu-item .dropdown-trigger").click((function(){e(this).siblings(".dropdown-menu").toggleClass("show")})),e(".search-button").click((function(){e(".search-overlay").toggleClass("in-view"),e(".search-overlay .search-field").focus()})),e(".search-close").click((function(){e(".search-overlay").hasClass("in-view")&&e(".search-overlay").removeClass("in-view")}));var t=1;function n(){var n=e(".category-link.current-cat").data("cat");e.ajax({url:"/wp-admin/admin-ajax.php",type:"POST",data:{action:"filter_blogs",page:t,category:n},beforeSend:function(){e("#blogFeed").removeClass("fade-in"),e("#blogFeed").html('<div class="my-6 py-6 text-center"><div class="my-lg-6 spinner-grow text-primary text-center mx-auto" role="status"><span class="visually-hidden">Loading...</span></div></div>')},success:function(t){e("#blogFeed").html(t),e("#blogFeed").addClass("fade-in")}})}e(".category-link").click((function(n){n.preventDefault(),t=1,e(".category-link").removeClass("current-cat"),e(this).addClass("current-cat")})),e(".category-link").on("click",n),e(document).on("click",".blog-feed-block .pagination a",(function(i){i.preventDefault(),e(this).attr("href"),t=e(this).attr("data-page"),e("html, body").animate({scrollTop:e(".blog-feed-block").offset().top-200},200),n()})),e(".modal").length&&e(".modal").prependTo(".site")})),e.Alert=T,e.Button=k,e.Carousel=I,e.Collapse=M,e.Dropdown=vt,e.Modal=Lt,e.Offcanvas=jt,e.Popover=Bt,e.Scrollspy=Wt,e.Tab=Vt,e.Toast=Ut,e.Tooltip=Rt}));
